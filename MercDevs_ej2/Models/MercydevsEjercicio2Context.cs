...
public partial class MercydevsEjercicio2Context : DbContext
{
    ...
    public virtual DbSet<Descripcionservicios> Descripcionservicios { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Descripcionservicios>(entity =>
        {
            entity.HasKey(e => e.IdDescServ);  // Asegúrate de tener la clave primaria configurada correctamente
            entity.ToTable("descripcionservicios");  // Nombre de la tabla en la base de datos
            // Configuraciones de propiedades y relaciones...
        });
        ...
        modelBuilder.Entity<Recepcionequipo>(entity =>
        {
            ...
            entity.Property(e => e.Nserie).HasMaxLength(45).HasColumnName("NSerie");
        ...
        modelBuilder.Entity<Servicio>(entity =>
        {
            ...
            entity.Property(e => e.UsuarioIdUsuario).HasColumnType("int(11)").HasColumnName("Usuario_idUsuario");
        ...
        modelBuilder.Entity<Usuario>(entity =>
        {
            ...
            entity.Property(e => e.Correo).HasMaxLength(45);
            entity.Property(e => e.Nombre).HasMaxLength(45);
            entity.Property(e => e.Password).HasMaxLength(64).HasColumnName("password");
        });
