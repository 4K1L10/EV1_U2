...
namespace MercDevs_ej2.Controllers
{
    public class ServiciosController : Controller
    {
        ...
        public async Task<IActionResult> ActualizarEstado(int id)
        {
            ...
            return RedirectToAction(nameof(Index)); // Redirige a la página principal de servicios
        }

        // GET: Servicios/DetallesEquipo/5
        public async Task<IActionResult> DetallesEquipo(int? id)
        {
            if (id == null)
            {
                return NotFound();
